...
spo.gametemplate.Tags = function(opt_data) {
  return '\t<div class="' + goog.getCssName('tags-container') + '"><div style="font-size:13px;font-weight:bold;">Add tags</div><div style="position:relative"><input class="' + goog.getCssName('form-values-left') + ' ' + goog.getCssName('field-tags') + '" type="text" value="' + soy.$$escapeHtml(opt_data.tags) + '"/><div class="' + goog.getCssName('goog-button') + ' ' + goog.getCssName('text-button') + ' ' + goog.getCssName('form-button') + '">Save</div></div></div>';
};
...
spo.gametemplate.Composer = function(opt_data) {
  return '<div class="' + goog.getCssName('mail-composer') + '"><div class="' + goog.getCssName('error') + ' ' + goog.getCssName('error-toolbar') + '" style="display: none;"></div><div class="' + goog.getCssName('toolbars-wrap') + ' ' + goog.getCssName('mail-bottom-border') + ' ' + goog.getCssName('mail-padded') + '"><div class="' + goog.getCssName('goog-button') + ' ' + goog.getCssName('form-button') + ' ' + goog.getCssName('text-button') + ' ' + goog.getCssName('send-button') + '" title="Send">Send</div><div class="' + goog.getCssName('goog-button') + ' ' + goog.getCssName('form-button') + ' ' + goog.getCssName('text-button') + ' ' + goog.getCssName('save-button') + '" title="Save">Save</div><div class="' + goog.getCssName('goog-button') + ' ' + goog.getCssName('form-button') + ' ' + goog.getCssName('text-button') + ' ' + goog.getCssName('attachment-button') + '">Attach file</div><div class="' + goog.getCssName('goog-button') + ' ' + goog.getCssName('from-button') + ' ' + goog.getCssName('text-button') + ' ' + goog.getCssName('template-button') + '">Templates</div><div class="' + goog.getCssName('goog-button') + ' ' + goog.getCssName('form-button') + ' ' + goog.getCssName('text-button') + ' ' + goog.getCssName('close-button') + '">Close</div><div class="' + goog.getCssName('goog-menu') + '" style="display: none;"><!--<div class="' + goog.getCssName('goog-menuitem') + '" data-template="draft">Load from draft</div>--><div class="' + goog.getCssName('goog-menuitem') + '" data-template="actionrequest">Action Request,</div><div class="' + goog.getCssName('goog-menuitem') + '" data-template="intelligence">Intelligence Request</div><div class="' + goog.getCssName('goog-menuitem') + '" data-template="meeting">Meeting Requests</div><div class="' + goog.getCssName('goog-menuitem') + '" data-template="meetingreport">Meeting Report</div><div class="' + goog.getCssName('goog-menuitem') + '" data-template="press">Press Release</div>' + ((opt_data.shouldSeeTeam) ? '<div class="' + goog.getCssName('goog-menuitem') + '" data-template="team">New Message</div>' : '') + '</div><div class="' + goog.getCssName('editor-toolbar') + '"></div></div><div class="' + goog.getCssName('fields-wrap') + ' ' + goog.getCssName('mail-bottom-border') + ' ' + goog.getCssName('mail-padded') + '"><div class="' + goog.getCssName('mail-composer-form-field') + '"><label>To:</label><input class="' + goog.getCssName('form-values') + ' ' + goog.getCssName('field-to') + '" type="text"/></div><div class="' + goog.getCssName('mail-composer-form-field') + '"><label>From:</label><input class="' + goog.getCssName('form-values') + ' ' + goog.getCssName('field-from') + '" type="text"/></div><div class="' + goog.getCssName('mail-composer-form-field') + '"><label>Subject:</label><input class="' + goog.getCssName('form-values') + ' ' + goog.getCssName('field-subject') + '" type="text"/></div></div><div class="' + goog.getCssName('web-form-container') + '"></div><div class="' + goog.getCssName('editor-field') + '" id="mail-composer-text-field"></div><div class="' + goog.getCssName('attachments') + '"></div></div>';
};
...
spo.gametemplate.MailBoxList = function(opt_data) {
  return ((opt_data.control == true) ? '<div class="' + goog.getCssName('mail-box-list') + ' ' + goog.getCssName('is-control-user') + '">' : '<div class="' + goog.getCssName('mail-box-list') + ' ' + goog.getCssName('not-control-user') + '">') + '<div class="' + goog.getCssName('detail-heading') + '">' + soy.$$escapeHtml(opt_data.header) + '</div></div>';
};
...
spo.gametemplate.MailPreview = function(opt_data) {
  ...
  var pathList375 = opt_data.attachments;
  var pathListLen375 = pathList375.length;
  for (var pathIndex375 = 0; pathIndex375 < pathListLen375; pathIndex375++) {
    var pathData375 = pathList375[pathIndex375];
    output += '<a class="attachment-link" target="_blank" href="' + pathData375 + '">' + opt_data.attachments_names[pathIndex375] + '</a>  ';
  }
