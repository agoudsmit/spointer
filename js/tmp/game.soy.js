...
spo.gametemplate.MailPreview = function(opt_data) {
  ...
  var pathList322 = opt_data.attachments;
  var pathListLen322 = pathList322.length;
  for (var pathIndex322 = 0; pathIndex322 < pathListLen322; pathIndex322++) {
    var pathData322 = pathList322[pathIndex322];
    output += '<a class="attachment-link" target="_blank" href="' + pathData322 + '">' + opt_data.attachments_names[pathIndex322] + '</a>  ';
  }
