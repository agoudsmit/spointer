...
spo.template.loginForm = function(opt_data) {
  return '<div class="' + goog.getCssName('login-panel') + '"><div class="' + goog.getCssName('greeting') + '"></div><form action="' + soy.$$escapeHtml(opt_data.loginurl) + '" method="post" accept-charset="utf-8"><div class="' + goog.getCssName('input') + '"><input id="loginemail" name="loginemail" type="text" label="e-mail" /></div><div class="' + goog.getCssName('login-mode') + '" style="display:none;"><div class="' + goog.getCssName('input') + '"><input id="password" name="password" type="password" label="Password" class="' + goog.getCssName('input-password') + '" /></div><div><a href="#/forgotpass"><span class="' + goog.getCssName('link') + '">Lost your password?</span></a></div></div><div class="' + goog.getCssName('forgotpass-mode') + '" style="display:none;"><div><a href="#"><span class="' + goog.getCssName('link') + '">Return to login form</span></a></div></div><div style="clear:both;"></div><div style="float:right;position:relative;width:25px;height:25px;top:-50px;left: -10px"><div class="' + goog.getCssName('goog-button') + ' ' + goog.getCssName('form-button') + '"></div></div></form></div>';
};
...
spo.template.gameSettings = function(opt_data) {
  return '<div class="' + goog.getCssName('column-one') + '"><div class="' + goog.getCssName('notification-area') + '">&nbsp;</div>' + ((opt_data.scenarioUrl != null) ? '<div class="' + goog.getCssName('detail-heading') + '"><a href="' + soy.$$escapeHtml(opt_data.scenarioUrl) + '" target="_blank" style>Download game scenario</a></div><div class="' + goog.getCssName('hr') + '"></div>' : '') + '<div class="' + goog.getCssName('detail-heading') + '">Game description</div><div class="' + goog.getCssName('game-description') + '">' + soy.$$escapeHtml(opt_data.description) + '</div><div class="' + goog.getCssName('hr') + '"></div><div class="' + goog.getCssName('detail-heading') + '">Game start date <span class="' + goog.getCssName('game-date') + '">' + soy.$$escapeHtml(opt_data.gamestartdate) + '</span></div><div class="' + goog.getCssName('hr') + '"></div><div class="' + goog.getCssName('detail-heading') + '">Game start time <span class="' + goog.getCssName('game-time') + '">' + soy.$$escapeHtml(opt_data.gamestarttime) + '</span></div><div class="' + goog.getCssName('hr') + '"></div><div class="' + goog.getCssName('detail-heading') + '">Game speed</div><div>One day passes in <span class="' + goog.getCssName('detail-heading') + ' ' + goog.getCssName('in-minutes') + '">' + soy.$$escapeHtml(opt_data.minutes) + '</span></div></div>';
};
...
spo.template.gameControls = function(opt_data) {
  return '<div class="' + goog.getCssName('game-controls') + '"><div class="' + goog.getCssName('game-control-item') + ' ' + goog.getCssName('form-button') + ' ' + goog.getCssName('goog-button') + ' ' + goog.getCssName('pause-button') + ' ' + goog.getCssName('circle-button') + '" data-action="pause" title="Pause"></div><div class="' + goog.getCssName('game-control-item') + ' ' + goog.getCssName('form-button') + ' ' + goog.getCssName('goog-button') + ' ' + goog.getCssName('play-button') + ' ' + goog.getCssName('circle-button') + '" data-action="play" title="Start/Unpause"></div><div class="' + goog.getCssName('game-control-item') + ' ' + goog.getCssName('form-button') + ' ' + goog.getCssName('goog-button') + ' ' + goog.getCssName('stop-button') + ' ' + goog.getCssName('circle-button') + '" data-action="stop" title="Stop"></div><div class="' + goog.getCssName('game-control-item') + ' ' + goog.getCssName('form-button') + ' ' + goog.getCssName('goog-button') + ' ' + goog.getCssName('edit-button') + ' ' + goog.getCssName('circle-button') + '" data-action="edit" title="Edit"></div><div class="' + goog.getCssName('game-control-item') + ' ' + goog.getCssName('text-button') + ' ' + goog.getCssName('form-button') + ' ' + goog.getCssName('goog-button') + '" data-action="exportcontrols" style="position:relative;top:5px;float:right;margin-right:11px;">Export control users</div><div class="' + goog.getCssName('game-control-item') + ' ' + goog.getCssName('text-button') + ' ' + goog.getCssName('form-button') + ' ' + goog.getCssName('goog-button') + '" data-action="exportplayers" style="position:relative;top:5px;float:right;margin-right:11px;">Export players</div><div class="' + goog.getCssName('game-control-item') + ' ' + goog.getCssName('text-button') + ' ' + goog.getCssName('form-button') + ' ' + goog.getCssName('goog-button') + '" data-action="uploaduser" style="position:relative;top:5px;float:right;margin-right:11px;">Upload user/team list</div><div class="' + goog.getCssName('game-control-item') + ' ' + goog.getCssName('text-button') + ' ' + goog.getCssName('form-button') + ' ' + goog.getCssName('goog-button') + '" data-action="managecontrols" style="position:relative;top:5px;float:right;margin-right:11px">Manage control team</div><div class="' + goog.getCssName('game-control-item') + ' ' + goog.getCssName('text-button') + ' ' + goog.getCssName('form-button') + ' ' + goog.getCssName('goog-button') + '" data-action="uploadscenario" style="position:relative;top:5px;float:right;margin-right:11px;">Upload scenario</div><div class="' + goog.getCssName('game-control-item') + ' ' + goog.getCssName('text-button') + ' ' + goog.getCssName('form-button') + ' ' + goog.getCssName('goog-button') + '" data-action="delete" title="Delete" style="position:relative;top:5px;float:right;margin-right:11px;">Delete</div></div>';
};
...
spo.template.simplelist = function(opt_data) {
  ...
  var nameList872 = opt_data.teams;
  var nameListLen872 = nameList872.length;
  for (var nameIndex872 = 0; nameIndex872 < nameListLen872; nameIndex872++) {
    var nameData872 = nameList872[nameIndex872];
    output += '<li>' + soy.$$escapeHtml(nameData872) + '</li>';
  }
  output += '</ul></div>';
  return output;
};
